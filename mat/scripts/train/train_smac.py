...
from mat.envs.Multi_UAV_Persuit.unity_rush_out import unity_wrapper_env
...
def get_unity_train_envs(number_parallel_env=8):
    # u3d_env = UnityEnvironment(file_name=r"../../envs/unity_enviroment/TankWar.exe", worker_id=4)
    # # create python Environment
    # py_env = python_env(num_agents=10, num_adversaries=5)

    env=unity_wrapper_env(number_parallel_env=number_parallel_env)
...
def main(args):
    ...
    envs = get_unity_train_envs(number_parallel_env=all_args.n_rollout_threads)
    num_agents = envs.py_env[0].num_goods
