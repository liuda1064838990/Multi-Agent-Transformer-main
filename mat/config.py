...
def get_config():
    ...
    parser.add_argument("--n_rollout_threads", type=int, default=2,
                        help="Number of parallel envs for training rollouts")###在这里修改环境个数
    ...
    # log parameters
    parser.add_argument("--log_interval", type=int, default=50, help="time duration between contiunous twice log printing.")
